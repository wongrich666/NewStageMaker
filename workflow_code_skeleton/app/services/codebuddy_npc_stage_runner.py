...
并填写场景承接、离场触发、时间承接、下一场地点、下一场第一有效动作五项内部执行字段。
...
相邻场景若从日变夜、从当日变次日或存在明显时间跨度，“时间承接”必须说明路程、等待或事件经过；
若紧接发生则写“紧接上一场，无时间跳跃”，且两场时段不得无故改变。
每场固定逐行输出：场景N、人物、关键道具、戏剧任务、场景承接、离场触发、时间承接、
下一场地点、下一场第一有效动作。最后五项是内部执行合同，不得合并或省略。
...
逐字落实逐集卡的“结尾状态→下一集第一有效动作”及每场的“场景承接→离场触发→时间承接→
下一场地点→下一场第一有效动作”。每场结尾必须演出换场原因和行动发起，下一场开头必须
兑现所承诺的动作；时段变化必须用路程、等待、天色或事件经过自然表现。可以省略无戏剧价值的
赶路，但不能省略决定、去向、行动目的和关键结果。
...
严格保留 scenes_per_episode 对应的场景数量规则；逐场核对上一场“时间承接/下一场地点/第一有效动作”
是否在下一场场景头和开头兑现。缺失时只补时间经过、人物离场原因、去向、行动发起及承接动作，
        ...
        while True:
            ...
            if stage == "episode_continuity":
                ...
                length_contract = (
                    ...
                    "包含场景承接、离场触发、时间承接、下一场地点和下一场第一有效动作。"
                )
            else:
