...
STAGE_LABELS = {
    ...
    "framework_scene_dictionary": "框架转剧本场景字典",
    "framework_appearance_mapping": "框架转剧本外观映射",
    "framework_enriched_episode_plan": "框架转剧本增强分集计划",
    "framework_causal_conflict": "框架转剧本因果冲突推进",
    "framework_causal_conflict_write": "框架转剧本因果冲突推进计划编写",
    "framework_causal_conflict_review": "框架转剧本因果冲突推进计划审核",
    "framework_causal_conflict_rewrite": "框架转剧本因果冲突推进计划修订",
    "framework_causal_conflict_memory": "框架转剧本因果冲突记忆",
    "framework_script": "框架转剧本正文对白融合",
    "framework_script_write": "框架转剧本正文对白融合编写",
    "framework_script_review": "框架转剧本正文对白融合审核",
    "framework_script_rewrite": "框架转剧本正文对白融合修订",
    "framework_script_memory": "框架转剧本正文记忆",
    "hook": "开头冲突钩子",
    "hooks": "开头冲突钩子",
