...
11. 用户在界面勾选的爆款蒸馏 Skill 是本轮新剧本的结构与写法约束。准备生成方案时必须保留其名称和发布版本；确认后必须把该精确版本交给专业剧本团队，不能自行替换、降级或忽略。Skill只迁移叙事功能、节拍关系和描写方法，不得把样本人物、关系套路、职业、场景、道具、证据手段、疾病或具体事件带入新故事。
