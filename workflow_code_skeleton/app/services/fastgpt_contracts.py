...
STAGE_SCRIPT_WRITE = STAGE_SCRIPT_WRITING
STAGE_SCRIPT_REVIEW = "script_review"
STAGE_SCRIPT_REWRITE = "script_rewrite"
STAGE_SCRIPT_REVISE = STAGE_SCRIPT_REWRITE
STAGE_MEMORY = "memory"
        ...
        for name, type_name in self.output_types.items():
            ...
            try:
                if self.stage_name == STAGE_CONSISTENCY and name == IS_CONSISTENT:
                    ...
                    self.stage_name in {STAGE_HOOKS_REVIEW, STAGE_DIALOGUES_REVIEW, STAGE_SCRIPT_REVIEW}
...
STAGE_CONTRACTS: dict[str, FastGPTStageContract] = {
    ...
    STAGE_SCRIPT_WRITING: FastGPTStageContract(
        ...
        output_types={BATCH_SCRIPT: "string"},
        output_aliases={BATCH_SCRIPT: (SCRIPT_CURRENT_VAR,)},
    ...
    STAGE_SCRIPT_REVIEW: FastGPTStageContract(
        ...
        output_aliases={
            REVIEW_PASSED: (SCRIPT_REVIEW_VAR, SCRIPT_REVIEW_OUTPUT_VAR, "approved"),
            REWRITE_REQUIRED: (SCRIPT_REVIEW_VAR, SCRIPT_REVIEW_OUTPUT_VAR),
            BLOCKING_ISSUES: (SCRIPT_REVIEW_VAR, SCRIPT_REVIEW_OUTPUT_VAR),
        },
