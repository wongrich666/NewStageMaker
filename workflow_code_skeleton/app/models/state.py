    ...
    def as_debug_dict(self) -> dict[str, Any]:
        return {
            "user_input": {
                ...
                "character_appearance_requirements": self.user_input.character_appearance_requirements,
                "character_alias_naming_rules": self.user_input.character_alias_naming_rules,
                "outfit_switch_rules": self.user_input.outfit_switch_rules,
